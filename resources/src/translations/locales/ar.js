...
export default {
    ...
    is_closed:'تم ألأقفال',
    closed_at:'تم الأقفال في',
    ad_ref_id:'الرقم المرجعي ',
    AdsList:'قائمة الأعلانات',
    ads:'أعلانات',
    ad:'اعلان',
    Ads:'الأعلانات',
    ListAds:'قائمة الأعلانات',
    ...
    preformance_status:'حالة أداء الأعلان',
    ...
    postponed_date:'التاريخ المؤجل له',
    ...
    vanex_storage_product_ref_id:'الرقم المرجعي للمنتج عند فانكس (بنغازي)',
