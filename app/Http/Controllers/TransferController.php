...
class TransferController extends BaseController
{
    ...
    {
        $this->authorizeForUser($request->user(), 'view', Transfer::class);
    ...
    {
        $this->authorizeForUser($request->user(), 'create', Transfer::class);
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->authorizeForUser($request->user(), 'update', Transfer::class);
        ...
        \DB::transaction(function () use ($request, $id) {
            ...
            if (!$view_records) {
                ...
                $this->authorizeForUser($request->user(), 'check_record', $current_Transfer);
            }
    ...
    {
        $this->authorizeForUser($request->user(), 'delete', Transfer::class);
    ...
    public function edit(Request $request, $id)
    {
        ...
        if (!$view_records) {
            // Check If User->id === Transfer->id
            $this->authorizeForUser($request->user(), 'check_record', $Transfer_data);
        }
