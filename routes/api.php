...
Route::middleware(['auth:api', 'Is_Active',ResolveTenantMiddleware::class ])->group(function () {
    ...
    Route::get("report/sales", "ReportController@Reporget_Products_by_warehouset_Sales");
    ...
    Route::get("report/ads_performance_report", "ReportController@ads_performance_report");
